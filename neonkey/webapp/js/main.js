...
import { initDigisellerModal } from './ui/digisellerModal.js';
import { renderProfile, initSignOut } from './ui/profileView.js';
...
(async function initApp() {
    ...
    const digisellerModal = initDigisellerModal();
    renderCatalog();
    initCatalogButtons(digisellerModal);
    initSignOut(() => {
        state.user = null;
        hideApp();
        authScreen.show();
    ...
    tg.ready();
    tg.expand();
    console.log('✅ NeonKey v2.0.0 загружен');
})();
