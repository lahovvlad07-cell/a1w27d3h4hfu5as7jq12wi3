...
export function loadAdminSettings() {
    ...
    const map = {
        ...
        admin_commission_type_usdt: s.commission_type_usdt,
        admin_commission_value_usdt: s.commission_value_usdt,
        admin_min_usdt: s.min_usdt,
        admin_commission_type_trx: s.commission_type_trx,
        admin_commission_value_trx: s.commission_value_trx,
        admin_min_trx: s.min_trx,
...
export function initAdminSettingsForm() {
    document.getElementById('adminSaveBtn').addEventListener('click', async () => {
        const newSettings = {
            ...
            commission_type_usdt: parseFloat(document.getElementById('admin_commission_type_usdt').value) || 0,
            commission_value_usdt: parseFloat(document.getElementById('admin_commission_value_usdt').value) || 0,
            min_usdt: parseFloat(document.getElementById('admin_min_usdt').value) || 0,
            commission_type_trx: parseFloat(document.getElementById('admin_commission_type_trx').value) || 0,
            commission_value_trx: parseFloat(document.getElementById('admin_commission_value_trx').value) || 0,
            min_trx: parseFloat(document.getElementById('admin_min_trx').value) || 0,
