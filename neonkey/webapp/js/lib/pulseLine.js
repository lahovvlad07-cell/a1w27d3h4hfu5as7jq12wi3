...
export function initPulseLine() {
    ...
    // На всякий случай — в текущей CSS никакой декларативной анимации у
    // .pulse-line больше нет (см. sections.css), но если кто-то вернёт её
    // обратно, это явно отключит её и не даст снова гоняться с этой,
    // JS-стороной. Длина пути каждый раз своя (форма случайна), поэтому
    // dasharray/dashoffset для эффекта "рисования" считаем динамически.
